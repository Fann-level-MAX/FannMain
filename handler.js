...
const fgclink = {
  ...
  let mentionedJid = [m.sender]
    let rown = {
        rowner: 'ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ *ᴅᴇᴠᴇʟᴏᴘᴇʀ ʙᴏᴛ*'}[type]
...
let own = {
owner: 'ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ *ᴏᴡɴᴇʀ ʙᴏᴛ*'}[type]
...
let mod = {
mods: 'ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ *ᴍᴏᴅᴇʀᴀᴛᴏʀ ʙᴏᴛ*'}[type]
...
let prm = {
        premium: 'ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ *ᴜsᴇʀ ᴘʀᴇᴍɪᴜᴍ*'}[type]
...
let gc = {
        group: 'ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ʙɪsᴀ ᴅɪᴘᴀᴋᴀɪ ᴅɪ *ᴅᴀʟᴀᴍ ɢʀᴏᴜᴘ*'
        }[type]
...
let msg = {
        private: 'ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ʙɪsᴀ ᴅɪᴘᴀᴋᴀɪ ᴅɪ *ᴘʀɪᴠᴀᴛᴇ ᴄʜᴀᴛ*',
        admin: '*ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ᴜɴᴛᴜᴋ *ᴀᴅᴍɪɴ ɢʀᴏᴜᴘ*',
        botAdmin: 'ᴄᴏᴍᴍᴀɴᴅ ɪɴɪ ʜᴀɴʏᴀ ʙɪsᴀ ᴅɪɢᴜɴᴀᴋᴀɴ ᴋᴇᴛɪᴋᴀ ʙᴏᴛ ᴍᴇɴᴊᴀᴅɪ ᴀᴅᴍɪɴ',
        restrict: 'ʀᴇsᴛʀɪᴄᴛ ʙᴇʟᴜᴍ ᴅɪɴʏᴀʟᴀᴋᴀɴ ᴅɪᴄʜᴀᴛ ɪɴɪ'}[type]
